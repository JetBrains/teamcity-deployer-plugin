...
<div class="parameter">
  Container URL: <strong><props:displayValue name="<%=DeployerRunnerConstants.PARAM_TARGET_URL%>" emptyValue="default"/></strong>
</div>

<div class="parameter">
    Container type: <strong><props:displayValue name="<%=DeployerRunnerConstants.PARAM_CONTAINER_TYPE%>" emptyValue="default"/></strong>
</div>
