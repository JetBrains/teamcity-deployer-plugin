...
<l:settingsGroup title="Deployment Target">
    <tr>
        ...
        <td><props:textProperty name="<%=SSHExecRunnerConstants.PARAM_HOST%>"  className="longField" maxlength="256"/>
...
<l:settingsGroup title="Deployment Credentials">
    <tr>
        ...
        <td><props:textProperty name="<%=SSHExecRunnerConstants.PARAM_USERNAME%>"  className="longField" maxlength="256"/>
            <span class="smallNote">Enter username</span>
        </td>
    </tr>
    <tr>
        <th><label for="my.buildServer.sshexec.password">Password:</label></th>
        <td><props:passwordProperty name="<%=SSHExecRunnerConstants.PARAM_PASSWORD%>"  className="longField" maxlength="256"/>
...
<l:settingsGroup title="Deployment source">
    <tr>
        ...
        <td>
            <props:textProperty name="<%=SSHExecRunnerConstants.PARAM_COMMAND%>"  className="longField" expandable="true"/>
